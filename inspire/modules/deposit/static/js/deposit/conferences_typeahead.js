...
define(function(require, exports, module) {
    ...
    this.$element.typeahead({
      ...
      templates: {
        ...
        suggestion: function(data) {
          return that.suggestionTemplate.render.call(
            that.suggestionTemplate, data.conference
          );
        }
      }
    });
  ...
  ConferencesTypeahead.prototype = {
    ...
    /**
     * A function which overwrites typeahead's setInputFieldValue(), shows
     * a description of a autocompleted value.
     *
     ...
     * @returns {Array} array of tokens; the result query is a one consisting
     *   of queries for every token connected with OR operator
     */
    datumTokenizer: function datumTokenizer(datum) {
      ...
      if (datum.title && (typeof datum.title) === 'string') {
        ...
        titleNameTokens = $.map(titleNameTokens,
          this._trimNonAlphaNumericChar
        );
    ...
    onKeydown: function onKeydown(event) {
      ...
      if ((keyCode === 8 || keyCode === 46) &&
        this.isFieldValueAutocompleted()) {
        ...
        this.ttTypeahead._onQueryChanged('queryChanged',
  ...
  $.fn.conferencesTypeahead = jQueryPlugin(ConferencesTypeahead,
    'conferences-typeahead');
  ...
  $.fn.conferencesTypeahead.defaults = {
    ...
    suggestionTemplate: {},
    /**
     * @param {Hogan template} a template used to render a the descriptive
     *   field value
     */
