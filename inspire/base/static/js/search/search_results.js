define(
  ...
  function($, defineComponent) {
    ...
    function SearchResults() {
      ...
      this.onShowYearOptions = function(ev) {
        var id = $(ev.target).attr('id');
        var element = document.getElementById(id);        
        var toggle_element = $(element).attr('toggle-element');
        $('#' + toggle_element).slideToggle('fast');
      }
      ...
      this.after('initialize', function() {
        ...
        this.on(".facets-btn", "click", this.onShowYearOptions);
