   ...
   $(window).ready(function() {
     ...
     function doneResizing() {
       ...
       if (wi > 767) {
         ...
         responsiveDropdown("#second-element", "#tools", "#second-arrow");
         responsiveDropdown("#third-element", "#conferences", "#third-arrow");
         responsiveDropdown("#fourth-element", "#journals", "#fourth-arrow");
         responsiveDropdown("#fifth-element", "#experiments", "#fifth-arrow");
         responsiveDropdown("#sixth-element", "#institutions", "#sixth-arrow");
