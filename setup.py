...
install_requires = [
    ...
    'invenio-db[postgresql,versioning]~=1.0,>=1.0.0,<1.0.4',
    'invenio-files-rest>=1.0.0a22',
    'invenio-indexer~=1.0,>=1.0.0,<1.1.0',
