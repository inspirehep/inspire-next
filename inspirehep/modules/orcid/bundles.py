...
match_js = NpmBundle(
    "js/inspire_profile_matcher/profile_matcher/app.js",
    output="gen/inspirehep.profile_matcher.%(version)s.js",
...
match_css = NpmBundle(
    "scss/profile-matcher.scss",
    output='gen/inspirehep.profile_matcher.%(version)s.css',
