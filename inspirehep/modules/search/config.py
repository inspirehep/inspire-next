...
SPIRES_KEYWORDS = {
    ...
    'recid': 'recid',
    # bulletin
    'bb': 'parent_report_number',
    'bbn': 'parent_report_number',
    'bull': 'parent_report_number',
    'bulletin-bd': 'parent_report_number',
    'bulletin-bd-no': 'parent_report_number',
    'eprint': 'parent_report_number',
    # report number
    'r': 'parent_report_number',
    'rn': 'parent_report_number',
    'rept': 'parent_report_number',
    'report': 'parent_report_number',
    'report-num': 'parent_report_number',
    'parent_report_number': 'parent_report_number',
    # title
    'title': 'title',
    't': 'title',
    'ti': 'title',
