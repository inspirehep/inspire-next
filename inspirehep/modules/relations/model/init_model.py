...
def pregenerate_graph():
    for research_field_model in pregenerate_research_fields():
        yield research_field_model

    for scientific_rank_model in pregenerate_scientific_ranks():
        yield scientific_rank_model

    for countries_n_continents_model in pregenerate_countries_and_continents():
        yield countries_n_continents_model
