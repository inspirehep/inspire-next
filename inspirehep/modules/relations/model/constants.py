...
from inspire_schemas.utils import get_schema_path
...
COUNTRIES_TO_CONTINETS = {
    ...
    'BL': {'continent': ['North America'], 'name': 'Saint-Barthelemy'},
    ...
    'GS': {'continent': ['Antarctica', 'South America'],
    ...
    'MF': {'continent': ['North America'], 'name': 'Saint Martin'},
    ...
    'PM': {'continent': ['North America'], 'name': 'Saint Pierre and Miquelon'},
    'PN': {'continent': ['Oceania'], 'name': 'Pitcairn Islands'},
    'PR': {'continent': ['North America'], 'name': 'Puerto Rico'},
    ...
    'RE': {'continent': ['Africa'], 'name': 'Reunion'},
    ...
    'SI': {'continent': ['Europe'], 'name': 'Slovenia'},
    'SJ': {'continent': ['Europe'], 'name': 'Svalbard and Jan Mayen'},
    ...
    'ST': {'continent': ['Africa'], 'name': 'Sao Tome and Principe'},
    'SU': {'continent': ['Europe', 'Asia'], 'name': 'Soviet Union'},
    'SX': {'continent': ['North America'], 'name': 'Sint Maarten'},
    'SY': {'continent': ['Asia'], 'name': 'Syria'},
    'TC': {'continent': ['North America'], 'name': 'Turks and Caicos Islands'},
    ...
    'WF': {'continent': ['Oceania'], 'name': 'Wallis and Futun'},
    'YE': {'continent': ['Asia'], 'name': 'Yemen'},
    'VI': {'continent': ['North America'], 'name': 'U.S. Virgin Islands'},
    'VG': {'continent': ['North America'], 'name': 'British Virgin Islands'},
...
COUNTRY_CODE_SCHEMA = json.loads(
        # TODO: import it properly
        open(get_schema_path('elements/country_code'), 'r').read()
        )
