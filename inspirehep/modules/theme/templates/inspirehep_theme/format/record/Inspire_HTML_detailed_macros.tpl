...
{% macro record_buttons(record) %}
  {% if record.get('arxiv_eprints') %}
    ...
    {% endif %}
  {% endif %}
  <inspire-export-modal button-template="/assets/node_modules/inspirehep-search-js/dist/templates/export/templates/button_single.html" body-template="/assets/node_modules/inspirehep-search-js/dist/templates/export/templates/modalbody.html" recid={{record['control_number']}}>
