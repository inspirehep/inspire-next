      ...
      <div class="record-header">
        <div class="row">
          <div class="col-md-9">
            ...
            {% if record['cnum'] %}
              {#<div> {{ record | proceedings_link }} </div>#}
            {% endif %}
          ...
          <div class="col-md-3" id="conference-detailed-map">
            {% block javascript %}
            {{ super() }}
              <script>
                function initMap() {
        ...
        <div class="row">
          <div class="col-md-12">
            ...
            {% if record['series'] %}
                <!-- TO-DO: change 'references' -->
                <div class="panel" id="other-conferences">
                  <div class="panel-heading">
                    <div id="record-reference-title">
                      {{ (record.get('references', '')) | count }} other conferences in this series
                    </div>
                  </div>
              ...
              {# {{ record['series'][0] | other_conferences_in_this_series }} #}
            {% endif %}
          </div>
        </div>
      </div>
