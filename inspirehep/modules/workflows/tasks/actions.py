...
def refextract(obj, eng):
    ...
    if 'references' in obj.data:
        raw_refs_list, references = raw_refs_to_list(obj.data['references'])
        extracted_references = dedupe_list(extract_references_from_reference_list(raw_refs_list, custom_kbs_file=journal_kb_dict, source=source))
