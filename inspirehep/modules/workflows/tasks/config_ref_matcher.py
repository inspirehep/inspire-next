...
#
# Configuration used for reference matching all HEP records.
#
...
#
# Configuration used for JCAP and JHEP records.
#
...
#
# Configuration used data records.
#
...
index and doc_type are different from config_general and
config_jcap_jhep."""
