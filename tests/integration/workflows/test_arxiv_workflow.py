...
def test_do_not_repeat(
    ...
    expected_persistent_data_first_run = {"one": {"id": 1}, "two": {"id": 2}}
    ...
    with workflow_app.app_context():
        ...
        assert (
            obj.extra_data["source_data"]["persistent_data"] == expected_persistent_data_first_run
        )
        ...
        obj = eng.processed_objects[0]
        assert (
            obj.extra_data["source_data"]["persistent_data"] == expected_persistent_data_second_run
        )
