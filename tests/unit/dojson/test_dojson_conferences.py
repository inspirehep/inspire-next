...
def test_titles_from_marcxml_111_with_two_a():
    """Test title with multiple a subfields."""
    snippet = (
        '<record> '
        '<datafield tag="111" ind1=" " ind2=" "> '
    ...
    record = strip_empty_values(conferences.do(create_record(snippet)))
    title0 = u'Conférence IAP 2013'
    subtitle0 = 'The origin of the Hubble sequence'
    title1 = '75 Anniversary Conference'
    subtitle1 = 'The origin of the Hubble sequence'
    assert record['titles'][0]['title'] == title0
    assert record['titles'][0]['subtitle'] == subtitle0
    assert record['titles'][1]['title'] == title1
    assert record['titles'][1]['subtitle'] == subtitle1
